...
export default function PatientRecordsPage() {
 ...
 <button className="w-full py-4 border border-slate-200 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-white border-blue-100 shadow-sm transition-all flex items-center justify-center gap-2 relative z-10">
