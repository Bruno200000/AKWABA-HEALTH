...
export default function StaffSchedulePage() {
 ...
 <p className="text-slate-600 font-medium">Gérez les rotations et les horaires de garde de l'équipe.</p>
 </div>
 ...
 <p className="text-[10px] font-bold text-slate-600 uppercase tracking-tighter">{staff.unit}</p>
 </div>
 </motion.div>
 ))}
 </div>
