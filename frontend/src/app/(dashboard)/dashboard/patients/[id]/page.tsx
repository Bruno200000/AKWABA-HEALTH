    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <button className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-bold hover:bg-slate-50 transition-all">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
        <div className="h-32 bg-gradient-to-r from-blue-600 to-indigo-600 relative">
            <div className="absolute -bottom-12 left-8 p-1 bg-white dark:bg-slate-900 rounded-3xl">
        ...
        <div className="pt-16 pb-8 px-8 flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="flex gap-6 items-center p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/20 p-6 rounded-3xl">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {patient.allergies?.length > 0 ? patient.allergies.map((a: string) => (
                        <span key={a} className="px-3 py-1.5 bg-white dark:bg-slate-900 border border-red-200 text-red-700 text-xs font-bold rounded-xl shadow-sm">{a}</span>
                      )) : <p className="text-sm text-red-400 font-medium">Aucune allergie répertoriée</p>}
                    </div>
                  </div>

                  {/* Insurance */}
                  <div className="bg-indigo-50 dark:bg-indigo-900/10 border border-indigo-100 dark:border-indigo-900/20 p-6 rounded-3xl">
                    ...
                    {patient.insurance_provider ? (
                      <div className="space-y-1">
                        <p className="text-sm font-bold text-indigo-900 dark:text-indigo-200">{patient.insurance_provider}</p>
                        <p className="text-xs text-indigo-600 dark:text-indigo-400 font-medium">Police: {patient.insurance_number}</p>
                      </div>
                    ) : (
                ...
                <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
                  ...
                  <div className="space-y-6">
                    {history.consultations.slice(0, 3).map((c: any, i: number) => (
                      <div key={c.id} className="relative pl-6 before:absolute before:left-0 before:top-2 before:bottom-0 before:w-0.5 before:bg-slate-100 dark:before:bg-slate-800">
                        <div className="absolute left-[-4px] top-1.5 w-2.5 h-2.5 rounded-full bg-blue-500 border-2 border-white dark:border-slate-950" />
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
                  ...
                  <div className="mb-6 p-4 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl text-center hover:border-blue-500 transition-all cursor-pointer group">
                  ...
                  <div className="space-y-3">
                    <div className="p-3 border border-slate-100 dark:border-slate-800 rounded-xl flex items-center gap-3 hover:bg-slate-50 transition-all cursor-pointer group">
