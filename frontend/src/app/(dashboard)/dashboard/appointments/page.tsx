  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Rendez-vous</h1>
          <p className="text-slate-500 dark:text-slate-400 font-medium">Planifiez et gérez le flux de patients de votre établissement.</p>
        </div>
        <button 
          ...
          <div className="space-y-4">
             {isLoading ? (
               ...
               <motion.div 
                 ...
                 className="bg-white dark:bg-slate-900 p-6 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-sm flex items-center justify-between group hover:shadow-xl hover:-translate-y-1 transition-all"
               >
