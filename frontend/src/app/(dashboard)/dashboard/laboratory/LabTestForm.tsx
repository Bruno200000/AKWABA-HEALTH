...
export default function LabTestForm({ onSuccess, onCancel }: LabTestFormProps) {
 ...
 <select required name="test_type" value={formData.test_type} onChange={handleChange} className="w-full px-4 py-3 bg-white border-blue-100 shadow-sm  rounded-2xl focus:ring-2 focus:ring-blue-500/20 outline-none">
 ...
 <textarea name="notes" value={formData.notes} onChange={handleChange} className="w-full px-4 py-3 bg-white border-blue-100 shadow-sm  rounded-2xl focus:ring-2 focus:ring-blue-500/20 outline-none min-h-[100px]" placeholder="Pourquoi cet examen ? Précisions médicales..." />
 </div>
 </div>
