...
export default function ResultEntry({ test, onCancel, onSuccess }: { test: any, onCancel: () => void, onSuccess: () => void }) {
 ...
 className="flex-[2] py-4 bg-blue-600 text-white rounded-[20px] font-black text-xs uppercase tracking-widest hover:bg-blue-700 transition-all shadow-xl shadow-blue-200 flex items-center justify-center gap-2"
 >
