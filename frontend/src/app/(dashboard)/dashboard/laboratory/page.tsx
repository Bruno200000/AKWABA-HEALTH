      ...
      {activeView === "list" ? (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Laboratoire</h1>
              <p className="text-slate-500 dark:text-slate-400 font-medium">Suivez les prélèvements et gérez les résultats d&apos;analyses.</p>
            </div>
            <button 
                    ...
                    <tr key={test.id} className="hover:bg-slate-50/50 transition-colors cursor-pointer group">
                      ...
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-2">
                           ...
                           <span className="font-black text-xs text-slate-700 dark:text-slate-300">{test.test_type}</span>
                        </div>
                      </td>
