...
export default function PatientRecordsPage() {
 ...
 <p className="text-slate-500 font-medium">Gestion sécurisée des antécédents et documents patients.</p>
 </div>
 ...
 key={rec.id}
 whileHover={{ y: -5 }}
 className="p-8 bg-white rounded-[40px] border border-slate-200 shadow-sm relative group overflow-hidden"
 >
 ...
 <button className="w-full py-4 border border-slate-200 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-50 transition-all flex items-center justify-center gap-2 relative z-10">
