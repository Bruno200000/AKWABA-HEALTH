  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Historique des Ventes</h1>
          <p className="text-slate-500 dark:text-slate-400 font-medium">Suivi en temps réel des transactions de la pharmacie.</p>
        </div>
        <div className="flex gap-3">
           ...
           <button className="px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-bold hover:bg-slate-50 transition-all shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {sales.map((sale) => (
          <motion.div
            ...
            className="p-6 bg-white dark:bg-slate-900 rounded-[32px] border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden group"
          >
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 flex justify-between items-end">
               <div>
                  ...
                  <p className="text-2xl font-black text-slate-900 dark:text-white">{sale.total.toLocaleString()} CFA</p>
               </div>
